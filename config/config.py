...
original_measurements_innsbruck_file = '/data/dmb20/Loop.Detector.Data.41.Cities/Loop.Detector.Measurements/loops_measurements_innsbruck_corrected.csv'
original_measurements_zurich_file1 = '/data/dmb20/Loop.Detector.Data.41.Cities/Loop.Detector.Measurements/loops_measurements_zurich_corrected.csv'
original_measurements_zurich_file2 = '/data/dmb20/Loop.Detector.Data.41.Cities/Loop.Detector.Measurements/loops_measurements_zurich_3min_1year.csv'
